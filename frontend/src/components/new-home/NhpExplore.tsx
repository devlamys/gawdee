  ...
  return (
    <article className="nhp-card" data-category={item.categoryKey || item.category?.toLowerCase()}>
      ...
      <div className="nhp-card__body">
        ...
        {item.description && <p className="nhp-card__desc" style={{ fontSize: '0.85rem', color: '#7a8a80', marginTop: '2px', margin: 0 }}>{item.description.length > 300 ? `${item.description.substring(0, 300)}...` : item.description}</p>}
